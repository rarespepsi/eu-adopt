...
KIND_ADOPTION_PENDING_EXPIRED_ADOPTER = "adoption_pending_expired_adopter"
...
# Invitație către transportator (job deschis) — aliniază plicul navbar cu panoul My transport
KIND_TRANSPORT_INVITE_OPERATOR = "transport_invite_operator"
