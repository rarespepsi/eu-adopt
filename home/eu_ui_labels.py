...
_EN: dict[str, str] = {
    ...
    "contact_legal_reg_com": "Trade register no.:",
    ...
    "prelaunch_hint_title": "Tip",
    "prelaunch_hint_close": "Close",
    "prelaunch_hint_ok": "Got it",
    "prelaunch_hint_mypet": "MyPet: add published animals, then you can promote a dog on Home.",
    "prelaunch_hint_publicitate_harta": "Advertising: pick a slot on the map, add it to the cart and complete checkout.",
    "prelaunch_hint_publicitate_cos": "Advertising cart: move to the general Cart → Pay → activation.",
    "prelaunch_hint_collab_offers": "Partner offers: publish services/products from My shop.",
    "prelaunch_hint_pets_all": "Find a friend: browse listings; from a profile you can promote an animal on the Home grid.",
    "prelaunch_hint_i_love_cos": "Cart: review your items and continue to payment when ready.",
    "prelaunch_banner_label": "Notice",
    "prelaunch_banner_body": "Some commercial features may be temporarily unavailable. Advertising and Home-grid promotion remain available where offered.",
    "prelaunch_msg_shop": "The Shop is temporarily unavailable on this site. Please use Find a friend, Transport and the other open sections.",
    "prelaunch_msg_donatii": "Online donations are temporarily unavailable. Thank you for your interest.",
    "prelaunch_msg_custi": "The crates / coach page is temporarily unavailable.",
    "prelaunch_msg_checkout": "The cart contains items that cannot be completed right now. Remove them or try again later.",
    "prelaunch_msg_cart_add": "You cannot add this item to the cart right now.",
    "prelaunch_msg_adopt": "Use the adoption form on this profile to contact the owner / shelter.",
    "pub_nudge_label": "INFO",
    "pub_nudge_text": "Advertising slots are available on the rate map.",
    "pub_nudge_later": "Later",
    "pub_nudge_cta": "Open advertising",
    "prelaunch_disc_title": "EU-Adopt",
    "prelaunch_disc_body": "Sign in with your account to manage listings and preferences. New accounts can be created from the signup link.",
    "checkout_prelaunch_free": "Activation is free for this order — no payment is required.",
    "login_pre_left_aria": "About EU-Adopt",
    "login_pre_badge": "EU-Adopt",
    ...
    "login_pre_p3": "Browse listings, contact shelters and manage your account from one place.",
    "login_pre_emph": "Create an account or sign in to use the full platform.",
    "login_pre_right_aria": "What you can do",
    "login_pre_heading": "On this site you can:",
    "login_pre_li1": "browse animals looking for a home;",
    "login_pre_li2": "request adoption and contact shelters;",
    "login_pre_li3": "publish listings from MyPet;",
    "login_pre_li4": "use Transport and other open sections.",
    "login_pre_max": "Add animals and update their profiles any time from MyPet.",
    "login_pre_report": "Please report any error, blockage or incorrectly displayed information. Your feedback helps us improve the platform.",
    "login_pre_launch": "Thank you for choosing EU-Adopt for responsible adoption.",
    ...
    "onboard_publicitate_harta_text": "Pick a slot on the map, see details on the left and add it to the cart.",
    ...
    "onboard_shop_s3": "Products — click a card for details and cart.",
    "onboard_publicitate_cos_title": "Advertising cart",
    "onboard_publicitate_cos_text": "Check the chosen slots and periods, then go to payment / activation.",
    ...
    "onboard_i_love_cos_text": "The cart brings together Services offers and advertising. Check the lines and continue to payment when ready.",
    ...
    "transport_hint_from_maps": "Typeahead or “Pick on map” in Romania (origin).",
    "transport_hint_to_maps": "Typeahead or “Pick on map” in the destination country.",
    "transport_hint_maps_tab": "You can open the map in the adjacent tab.",
    ...
    "pet_copy_loc_title": "Copy PET location",
    "pet_copy_loc_btn": "Copy",
    "pet_copy_loc_done": "Copied",
    "pet_copy_loc_aria": "Pet location to copy for transport",
    "pet_adopt_demo_note": "Demo only",
    "pet_adopt_inactive_note": "Temporarily inactive",
    ...
    "pet_adopt_inactive_msg": (
        "Adoption is temporarily unavailable for this listing. "
        "Please try again later or contact the shelter from the profile."
    ),
    "pet_adopt_intro": (
    ...
    "promo_prelaunch_banner": "Promotion",
    "promo_prelaunch_max": "check the offer details for limits",
    "promo_pet": "Pet",
    ...
    "promo_msg_one_only": "You can activate only one A2 promotion per account with the current offer.",
    ...
    "promo_msg_added_free": " Activation is free for this order.",
