...
class AnimalListing(models.Model):
    ...
    color = models.CharField("Culoare", max_length=40, blank=True)
    ...
    sterilized = models.BooleanField("Sterilizat", default=False)
    vaccinated = models.BooleanField("Vaccinat", default=False)
    has_health_book = models.BooleanField("Carnet de sănătate", default=False)
    has_chip = models.BooleanField("CIP", default=False)
    trait_playful = models.BooleanField("Jucăuș", default=False)
    trait_affectionate = models.BooleanField("Iubitor", default=False)
    trait_protective = models.BooleanField("Protector", default=False)
    trait_energetic = models.BooleanField("Energic", default=False)
    trait_calm = models.BooleanField("Liniștit", default=False)
    trait_good_with_kids = models.BooleanField("Bun cu copii", default=False)
    trait_good_with_dogs = models.BooleanField("Bun cu alți câini", default=False)
    trait_good_with_cats = models.BooleanField("Bun cu pisici", default=False)
    trait_house_trained = models.BooleanField("Obișnuit în casă", default=False)
    trait_leash_trained = models.BooleanField("Obișnuit cu lesa", default=False)
    trait_low_barker = models.BooleanField("Nu latră excesiv", default=False)
    trait_apartment_ok = models.BooleanField("Potrivit pentru apartament", default=False)
    trait_adapts_easily = models.BooleanField("Se adaptează ușor", default=False)
    trait_ok_left_alone = models.BooleanField("Tolerează să stea singur", default=False)
    trait_needs_experienced_owner = models.BooleanField("Necesită experiență cu câini", default=False)
    trait_good_for_yard = models.BooleanField("Bun la curte", default=False)
    medical_issues = models.TextField("Probleme medicale", blank=True)
    about_pet = models.TextField("Cine sunt și de unde sunt", blank=True)
    photo_1 = models.ImageField("Poză 1", upload_to="pets/", blank=True, null=True)
    photo_2 = models.ImageField("Poză 2", upload_to="pets/", blank=True, null=True)
    photo_3 = models.ImageField("Poză 3", upload_to="pets/", blank=True, null=True)
