...
PUBLIC_GET_200_NAMES = [
    ...
    "custi",
    "donatii_generale",
    "donatii_formular_230",
    "donatii_contract_sponsorizare",
    "contact",
    "termeni",
    "termeni_read",
    ...
    def test_mypet_add_species_query_dog_cat_other(self):
        ...
        for species in ("dog", "cat", "other"):
            with self.subTest(species=species):
                ...
                self.assertEqual(r.status_code, 200)
                self.assertContains(r, "mypet-add-form", status_code=200)
                self.assertContains(r, "id_species_kind", status_code=200)
                self.assertNotContains(r, "mypetSpeciesPills", status_code=200)
