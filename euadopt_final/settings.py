...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.eu_legal_identity',
            ],
        },
    },
]
...
_media_cron_on = os.environ.get("EUADOPT_MEDIA_OUTREACH_CRON_ENABLED", "").strip().lower()
MEDIA_OUTREACH_CRON_ENABLED = _media_cron_on in ("1", "true", "yes", "on")
MEDIA_OUTREACH_CRON_WAVE_SIZE = int(os.environ.get("EUADOPT_MEDIA_OUTREACH_CRON_WAVE_SIZE", "0") or "0")
# Mail duminică: mulțumire membri noi + recomandare colaboratori (o dată / user)
_weekly_thanks = os.environ.get("EUADOPT_WEEKLY_NEW_MEMBER_THANKS_EMAIL_ENABLED", "1").strip().lower()
WEEKLY_NEW_MEMBER_THANKS_EMAIL_ENABLED = _weekly_thanks not in ("0", "false", "no", "off")
